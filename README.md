...
[![GitHub Repo](https://img.shields.io/badge/GitHub-View%20Repository-black?style=flat\&logo=github)](https://github.com/Devesh-Yadav22/product-catalog)

---

## 🌐 Live Demo

👉 **https://product-catalog-gmij.onrender.com**

---

## 📂 GitHub Repository

👉 **https://github.com/Devesh-Yadav22/product-catalog**
...
```bash
git clone https://github.com/Devesh-Yadav22/product-catalog.git
cd product-catalog
...
4. Visit
   👉 https://Devesh-Yadav22.github.io/product-catalog/product-catalog.html
...
Search for `Lumière` in the HTML file and replace it.

### Add a new product

Add inside the `PRODUCTS` array:
